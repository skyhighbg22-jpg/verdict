...
const GELPanel = () => {
  ...
  return (
    <motion.div 
      className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 min-w-[300px]"
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-bold text-gray-800">GEL Panel</h3>
        <span className="text-xs text-gray-400 ml-auto">Verified Facts</span>
      </div>
      ...
      >
        <div className="flex justify-between items-center text-xs text-gray-500">
          ...
          <span className="font-semibold text-gray-700">{verifiedFacts.length}</span>
        </div>
    ...
    >
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1">
          <p className="text-sm text-gray-700 leading-snug">{fact.text}</p>
          <p className="text-[10px] text-gray-400 mt-1">{fact.source}</p>
        </div>
      </div>
      <div className="flex items-center gap-2 ml-6">
        ...
        <motion.span 
          className={clsx(
            ...
            fact.certainty >= 0.9 ? "text-emerald-600" :
            fact.certainty >= 0.7 ? "text-yellow-600" : "text-orange-600"
          )}
